...
def main(args):
    ...
    register_coco_instances("test", {}, "/content/detectron2_2_tensorrt/datasets/coco/annotations/instances_val2017.json", "/content/detectron2_2_tensorrt/datasets/coco/val2017/")
    dataset_name = 'test'
